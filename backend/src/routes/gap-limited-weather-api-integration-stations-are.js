...
const FEATURE_SLUG = 'limited-weather-api-integration-stations-are';
const FEATURE_TITLE = 'Limited weather API integration (stations are internal records)';
const PROJECT = 'AISkiResortOperationsManager';
